...
| :pencil2: Qwen Edit (`/qwen_edit`) (NEW!) | Edit one image or combine two images using Qwen Image 2.1. Supports cfg, steps, sampler, scheduler. Output resolution follows the input image(s). |
