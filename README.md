...
| File                  | Role                                                                                        |
| --------------------- | ------------------------------------------------------------------------------------------- |
| `bot.py`              | Main bot: commands, views, buttons, NSFW guard, progress bar                                |
...
```
comfyuidiscord/
├── bot.py                  # Main bot (commands, views, buttons)
...
- The `--allow-cors` flag is passed to `bot.py` (it does not affect ComfyUI itself).
