...
class LLMCog(commands.Cog):
    """LLM prompt-generation commands: /gen_prompt /llm_models"""

    def __init__(self, bot: commands.Bot) -> None:
        self.bot = bot

    @app_commands.command(name="gen_prompt", description="Convert a natural-language prompt into an Ideogram 4 JSON caption prompt")
    ...
    async def gen_prompt(self, interaction: discord.Interaction, prompt: str,
    ...
    @app_commands.command(name="llm_models", description="List the LLM models available on the configured endpoint")
